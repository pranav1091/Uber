<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="R_Trips.aspx.cs" Inherits="R_Trips" %>
        ...
        <tr>
            ...
            <td class="style2">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                    ...
                    DataSourceID="SqlDataSource1" Font-Names="Comic Sans MS" Font-Size="Small" 
                    Height="168px" Width="631px">
                    <Columns>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT [Driver], [Pickup], [Car], [City], [Fare], [Payment_Method] FROM [Trips]">
                </asp:SqlDataSource>
            </td>
            <td>
                &nbsp;</td>
