<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="R_Login_page.aspx.cs" Inherits="Login_page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width:100%; height: 471px; background-image: url('Images/new_york_taxi_large.jpg');">
    <tr>
        <td class="style1">&nbsp;</td>
        <td class="style2">&nbsp;</td>
        <td>&nbsp;</td>
