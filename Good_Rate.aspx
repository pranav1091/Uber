<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Good_Rate.aspx.cs" Inherits="Good_Rate" %>
                        ...
                        <tr>
                            <td class="style22" colspan="2">
                                ...
                                <asp:Label ID="Label4" runat="server" Font-Names="Consolas" Font-Size="Medium" 
                                    style="text-decoration: underline" Text="6 Drives Found near you " 
                                    Font-Underline="False"></asp:Label>
                                <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:Label ID="Label5" runat="server" Font-Names="Consolas" Font-Size="Medium" 
                                    style="text-decoration: underline" Text="Expected arrival time 8 Mins"></asp:Label>
                            </td>
                            <td class="style18">
                                &nbsp;</td>
                        </tr>
